...
<!--START footer-->
<div style="border-top: 1px solid <?php echo $nd_options_customizer_footer_4_border; ?>; <?php echo $nd_options_customizer_footer_4_bg_image; ?> " id="nd_options_footer_4" class="nd_options_section">
